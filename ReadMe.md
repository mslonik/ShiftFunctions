...
| basic         | a     | c     | e     | l     | o     | n     | s     | z     | x     |
| :---          | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **diacritic** | ą     | ć     | ę     | ł     | ó     | ń     | ś     | ż     | ź     |
| **no.**       | 1     | 2     | 3     | 4     | 5     | 6     | 7     | 8     | 9     |

| basic capital         | A     | C     | E     | L     | O     | N     | S     | Z     | X     |
| :---                  | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **diacritic** capital | Ą     | Ć     | Ę     | Ł     | Ó     | Ń     | Ś     | Ż     | Ź     |
...
| dominant tactics | n.a. | English keycaps + concept of layer (AltGr) | Polish keycaps + concpet of layer (AltGr) |
...
For temporary switching example for Polish (programmers) keyboard layout to get diacritic character "ą" user can press down dedicated for that purpose right Alt (called AltGr), then press down "a", then release "a" and release right Alt.
...
| :---             | :---:               |  :---:              |      :---:        | :---:       |
| dead key before  | /a                  |   ą                 | Hotstrings        |             |
| dead key after   |  a<Shift>           |   ą                 | Shift Diacritic   | ☑           |
| double / tripple | aa                  |   ą                 | Double Diacritic  |             |

<br /><br />
## Dead key before (Hotstrings)

The "dead key before" tactics actually is similar to "original" concept of "dead key" (see discussion above). My personal modification relies on fact that dead key 
- should be located in convenient area of keyboard,
- I don't mind if its pressing will be visible to user.
...
Quality judgement:
| quality feature                             |  advantage          | disadvantage | 
| :---                                        | :---:               |  :---:       | 
| how many keys have to be pressed: 2         |                     |   ☑         | 
| do keys have to pressed concurrently: no    |  ☑                 |              | 
| ergonomy: use of two hands all the time: no |                     |   ☑         | 
| can use modifier as dead key: no            |                     |   ☑         |

The tactics can be easily realized with use of [Hotstrings](https://github.com/mslonik/Hotstrings) applcation.

## Dead key after (Shift Diacritic)
...
| :---        | :---             |     :---                 |     :---            | :---:       |
|             | AltGr D          | secondary D              | a              D    | primary   D |
|             | AltGr D + a D    | secondary D + primary D  | a              U    | primary   U |
|             | AltGr D + a U    | secondary D + primary U  | Shift (R or L) D    | secondary D |
|             | AltGr U          | secondary U              | Shift (R or L) U    | secondary U |
| **output**  | ą                |                          | ą                   |             |
